    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form action="verify_gmail.php" method="POST" class="space-y-6">
            ...
            <div class="flex space-x-2 justify-center">
                <input type="text" name="code[]" maxlength="1" size="1" required class="w-12 h-12 text-center border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                <input type="text" name="code[]" maxlength="1" size="1" required class="w-12 h-12 text-center border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                <input type="text" name="code[]" maxlength="1" size="1" required class="w-12 h-12 text-center border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                <input type="text" name="code[]" maxlength="1" size="1" required class="w-12 h-12 text-center border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                <input type="text" name="code[]" maxlength="1" size="1" required class="w-12 h-12 text-center border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="text-center">
                <input type="submit" value="Verify" class="mt-4 bg-blue-600 text-white py-2 px-6 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
        </form>
    </div>
</body>
