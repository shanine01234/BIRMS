    ...
    <div class="signup-container">
        ...
        <form id="signup-form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="contact_num" name="contact_num" class="form-control my-2" required pattern="09[0-9]{9}" title="Contact number must be 11 digits and start with '09'">
            </div>
            <div class="form-group">
...
$(document).ready(function () {
    ...
    $('#signup-form').on('submit', function (e) {
        ...
        const contact_num = sanitizeInput($('#contact_num').val());
