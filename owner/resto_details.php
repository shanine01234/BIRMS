...
<head>
    ...
    <title>BIRMS | Owner Resto Details</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">My Resto Details</h1>
                        ...
                        <div class="card shadow mb-4 p-4 w-100">
                            ...
                            <div class="data_table">
                                <table id="dashprint" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php 
                                        $myrow = $oop->displayDetails($_SESSION['owner_id']);
                                        $k = 1;
                                        foreach($myrow as $row){
                                            ?>
                                            <tr>
                                             ...
                                             <div class="modal fade" id="deleteModal<?=$row['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="deleteDetails" class="btn btn-danger"><i class="align-middle" data-feather="trash"></i> Yes</button>
                                                        </form>
                                                    </div>
                                                    </div>
                                                </div>
